...
export default function ReceiptPage() {
  ...
  if (status === 'loading') return (
    <div style={{ textAlign: 'center', padding: '80px 20px', background: 'var(--bg)', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <span className="spinner" style={{ width: 32, height: 32, borderWidth: 3, marginBottom: 20 }} />
      <p style={{ color: 'var(--text2)', fontSize: 15, marginBottom: 8 }}>Loading receipt...</p>
      <p style={{ color: 'var(--text3)', fontSize: 12 }}>Fetching on-chain data from Arc Testnet</p>
    </div>
  )
  ...
  return (
    <div className="fade-up">
      ...
      <div style={{ padding: 14, background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 8, fontSize: 11, color: 'var(--text3)', lineHeight: 1.6 }}>
        ...
        ArcPay records self-declared merchant data and payment receipts only.
      </div>
    </div>
  )
}
