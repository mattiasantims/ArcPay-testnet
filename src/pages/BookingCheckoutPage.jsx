...
export default function BookingCheckoutPage() {
  ...
  async function handlePay() {
    ...
    try {
      ...
      navigate(`/payment-success?type=booking&txHash=${txHash||''}&bookingId=${bookingId}&amount=${req.totalAmount}&merchant=${req.merchant}&ref=${encodeURIComponent(req.bookingRef||'')}&mode=customer`)
    } catch (e) {
      console.error(e)
