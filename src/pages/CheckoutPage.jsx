  ...
  return (
    <div className="fade-up" style={{ maxWidth: 520, margin: '0 auto' }}>
      ...
      <div className="card" style={{ padding: 20 }}>
        <div style={{ fontSize: 11, color: 'var(--text3)', marginBottom: 14, textAlign: 'center', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          Or scan with mobile wallet
        </div>
        <QRCodeBox url={pageUrl} size={140} label="" />
        <div style={{ fontSize: 11, color: 'var(--text3)', textAlign: 'center', marginTop: 10, lineHeight: 1.6 }}>
          Open this link in MetaMask's built-in browser to pay from mobile
        </div>
      </div>
