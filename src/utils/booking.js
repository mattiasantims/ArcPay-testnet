...
import { ARCBOOKING_ADDRESS, USDC_ADDRESS, USDC_DECIMALS, ARCSCAN_BASE } from '../config.js'
...
export function buildBookingReceiptObject({ booking, txHash, bookingId, merchantName, description, merchantProfile }) {
  return {
    ...
    booking_page:         `${typeof window !== 'undefined' ? window.location.origin : ''}/booking/${bookingId}`,
