...
export function buildTravelReceiptObject({ travel, txHash, travelId, agencyName, description }) {
  ...
  return {
    ...
    disclaimer:               'TESTNET ONLY. Not a regulated escrow or travel booking service. ArcPay does not advance funds. Testnet tokens have no real economic value.',
  }
}
...
export function downloadTravelReceiptPDF(receipt) {
  ...
  doc.save(`arcpay_travel_${receipt.travel_id}.pdf`)
}
